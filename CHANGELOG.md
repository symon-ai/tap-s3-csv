...
- Remediate Veracode CWE-331 (Insufficient Entropy) in `tests/resources/tap-s3-csv/writer.py` by replacing the non-cryptographic `random` module with `secrets.SystemRandom()` for the test data generator [WP-33381]
