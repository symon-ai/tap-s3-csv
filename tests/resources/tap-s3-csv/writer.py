...
# Use a cryptographically-secure RNG (backed by os.urandom) instead of the
# default insecure Mersenne-Twister PRNG to satisfy CWE-331. SystemRandom
# exposes the same randint/random/uniform API and value ranges, so the
# generated fixture data keeps identical semantics.
