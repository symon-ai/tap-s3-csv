...
# CWE-331: use a cryptographically-strong RNG source instead of the `random`
# module's insecure Mersenne-Twister PRNG. SystemRandom is API-compatible
# (randint/random/uniform) and backed by os.urandom, so fixture output shape
# and call signatures are unchanged.
