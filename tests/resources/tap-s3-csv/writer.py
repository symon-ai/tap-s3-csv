...
# Use a cryptographically-strong RNG (CWE-331): SystemRandom exposes the same
# randint/random/uniform signatures as the stdlib random module, so this is a
# behavior-preserving drop-in for generating this fixture's sample data.
