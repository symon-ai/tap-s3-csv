...
# CWE-331: use a cryptographically secure RNG instead of the insecure
# module-level `random` functions. SystemRandom is a drop-in for the
# _RNG.* API (uniform / randint / random) used to generate CSV fixtures.
