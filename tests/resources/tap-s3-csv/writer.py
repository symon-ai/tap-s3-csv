...
# CWE-331 (WP-33354): route all random-value generation in this test-data
# generator through a cryptographically secure RNG (backed by os.urandom)
# instead of the default Mersenne Twister PRNG. SystemRandom is a drop-in
# subclass of random.Random, so randint/uniform/random keep identical
