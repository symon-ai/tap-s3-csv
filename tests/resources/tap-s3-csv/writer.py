...
# CWE-331: use a cryptographically-strong RNG (os.urandom-backed SystemRandom)
# instead of the default non-cryptographic PRNG for all synthetic test-data
# generation. SystemRandom is a drop-in for randint/uniform/random, so ranges,
