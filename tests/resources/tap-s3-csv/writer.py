...
# CWE-331: use a cryptographically-secure source of randomness for this
# test-fixture generator instead of the module-level (Mersenne Twister) PRNG.
# random.SystemRandom draws from os.urandom and exposes the same randint /
# uniform / random API, so generated-data semantics (ranges, signatures) are
# unchanged.
