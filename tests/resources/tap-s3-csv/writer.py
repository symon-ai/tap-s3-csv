...
# CWE-331: use a cryptographically secure, os.urandom-backed RNG instead of the
# default insecure PRNG. SystemRandom exposes the same randint/random/uniform
# API, so the fixture generator's behavior is preserved.
