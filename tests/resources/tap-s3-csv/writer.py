...
# CWE-331: source randomness from a cryptographically secure generator
# (SystemRandom is backed by os.urandom) instead of the module-global
# Mersenne-Twister PRNG. The .random()/.randint()/.uniform() API and the
# generated CSV structure are unchanged.
