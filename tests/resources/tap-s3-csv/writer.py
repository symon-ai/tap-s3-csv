...
# CWE-331: use a cryptographically-secure PRNG (backed by os.urandom) instead of
# the default Mersenne-Twister generator flagged by Veracode. SystemRandom is a
# drop-in for randint/random/uniform and preserves the value ranges below.
