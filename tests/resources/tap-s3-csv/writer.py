...
# non-cryptographic `random` module to satisfy Veracode CWE-331. SystemRandom
# exposes the same randint/uniform/random API, so the generated test-data
# shapes and ranges are unchanged.
