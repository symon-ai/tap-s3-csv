...
import sys
import random
# CWE-331: rebind to a cryptographically secure PRNG (os.urandom-backed).
# SystemRandom inherits random/randint/uniform, so every call site below
# uses sufficient entropy without any behavioural change.
