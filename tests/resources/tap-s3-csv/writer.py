...
# CWE-331: use a cryptographically-strong PRNG source instead of the module-level
# insecure Mersenne Twister. SystemRandom is a drop-in that exposes the same
# randint/random/uniform API and preserves the exact ranges/shape of the fixture
