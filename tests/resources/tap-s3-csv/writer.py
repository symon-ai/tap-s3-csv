...
# Use a cryptographically secure RNG (backed by os.urandom via SystemRandom)
# instead of the insecure default Mersenne Twister generator (CWE-331).
# SystemRandom exposes the same randint/uniform/random API, so fixture value
# ranges and data shapes are unchanged.
